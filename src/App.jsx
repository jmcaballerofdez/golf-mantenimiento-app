...
const VERDE = "#5C6B3F";
const VERDE_OSCURO = "#333B22";
const VERDE_NEGRO = "#1B1B14"; // sidebar, botones primarios — verde-carbón rico
const DORADO = "#A9743C";      // acento premium: líneas, eyebrows, indicador activo
const DORADO_SUAVE = "rgba(169,116,60,0.35)";
const CREMA = "#F2EEE3";       // mismo fondo que Master, para unidad de familia
...
const VERDE_TARJETA = "#22241A";       // superficie de las tarjetas sobre el fondo verde
const VERDE_TARJETA_SUAVE = "#282A1F"; // hover / filas alternas
const ORO_BRILLANTE = "#C89968";       // dorado más claro, para cifras y títulos destacados
const BLANCO = "#F1ECE0";
const BLANCO_SUAVE = "rgba(241,236,224,0.68)";
const BLANCO_TENUE = "rgba(241,236,224,0.42)";
